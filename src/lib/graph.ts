...
export const IDEAL_ROUTES: Record<string, { exit: string, blocks: { x: number, y: number }[] }[]> = {
  "DG": [
    { exit: "exit-1783495193815", blocks: [{ x: 829, y: 124 }, { x: 829, y: 209 }, { x: 948, y: 209 }, { x: 948, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783495193102", blocks: [{ x: 829, y: 124 }, { x: 829, y: 26 }, { x: 948, y: 26 }, { x: 948, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783495192196", blocks: [{ x: 829, y: 124 }, { x: 775, y: 124 }, { x: 775, y: 105 }, { x: 580, y: 105 }, { x: 580, y: 26 }, { x: 948, y: 26 }, { x: 948, y: 568 }, { x: 713, y: 568 }] },
  ],
  "CRA": [
    { exit: "exit-1783495197203", blocks: [{ x: 437, y: 361 }, { x: 580, y: 361 }, { x: 580, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783495474793", blocks: [{ x: 437, y: 361 }, { x: 285, y: 361 }, { x: 285, y: 290 }, { x: 60, y: 290 }, { x: 60, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783500239331", blocks: [{ x: 437, y: 361 }, { x: 437, y: 422 }, { x: 60, y: 422 }, { x: 60, y: 568 }, { x: 713, y: 568 }] },
  ],
  "CRA-2": [
    { exit: "exit-1783500239331", blocks: [{ x: 171, y: 485 }, { x: 171, y: 422 }, { x: 60, y: 422 }, { x: 60, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783495197203", blocks: [{ x: 171, y: 485 }, { x: 285, y: 485 }, { x: 285, y: 492 }, { x: 580, y: 492 }, { x: 580, y: 568 }, { x: 713, y: 568 }] },
  ],
  "CRA-3": [
    { exit: "exit-1783495474793", blocks: [{ x: 199, y: 361 }, { x: 60, y: 361 }, { x: 60, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783500239331", blocks: [{ x: 199, y: 361 }, { x: 60, y: 361 }, { x: 60, y: 422 }, { x: 60, y: 568 }, { x: 713, y: 568 }] },
  ],
  "CRA-4": [
    { exit: "exit-1783495474793", blocks: [{ x: 196, y: 171 }, { x: 60, y: 171 }, { x: 60, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783495191079", blocks: [{ x: 196, y: 171 }, { x: 60, y: 171 }, { x: 60, y: 26 }, { x: 60, y: 26 }, { x: 60, y: 568 }, { x: 713, y: 568 }] },
  ],
  "BH-0": [
    { exit: "exit-1783495191079", blocks: [{ x: 360, y: 71 }, { x: 285, y: 71 }, { x: 285, y: 26 }, { x: 60, y: 26 }, { x: 60, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783495474793", blocks: [{ x: 360, y: 71 }, { x: 285, y: 71 }, { x: 285, y: 290 }, { x: 60, y: 290 }, { x: 60, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783495192196", blocks: [{ x: 360, y: 71 }, { x: 580, y: 71 }, { x: 580, y: 26 }, { x: 948, y: 26 }, { x: 948, y: 568 }, { x: 713, y: 568 }] },
  ],
  "BH-1": [
    { exit: "exit-1783495192196", blocks: [{ x: 498, y: 71 }, { x: 580, y: 71 }, { x: 580, y: 26 }, { x: 948, y: 26 }, { x: 948, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783495191079", blocks: [{ x: 498, y: 71 }, { x: 285, y: 71 }, { x: 285, y: 26 }, { x: 60, y: 26 }, { x: 60, y: 568 }, { x: 713, y: 568 }] },
  ],
  "CRA-5": [
    { exit: "exit-1783495474793", blocks: [{ x: 381, y: 220 }, { x: 285, y: 220 }, { x: 285, y: 290 }, { x: 60, y: 290 }, { x: 60, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783495197203", blocks: [{ x: 381, y: 220 }, { x: 285, y: 220 }, { x: 285, y: 290 }, { x: 580, y: 290 }, { x: 580, y: 568 }, { x: 713, y: 568 }] },
  ],
  "HOT-1": [
    { exit: "exit-1783495197203", blocks: [{ x: 509, y: 190 }, { x: 580, y: 190 }, { x: 580, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783495192196", blocks: [{ x: 509, y: 190 }, { x: 580, y: 190 }, { x: 580, y: 26 }, { x: 948, y: 26 }, { x: 948, y: 568 }, { x: 713, y: 568 }] },
  ],
  "SA": [
    { exit: "exit-1783495197203", blocks: [{ x: 271, y: 525 }, { x: 271, y: 492 }, { x: 580, y: 492 }, { x: 580, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783500239331", blocks: [{ x: 271, y: 525 }, { x: 271, y: 492 }, { x: 60, y: 492 }, { x: 60, y: 568 }, { x: 713, y: 568 }] },
  ],
  "TA": [
    { exit: "exit-1783495197203", blocks: [{ x: 381, y: 525 }, { x: 381, y: 492 }, { x: 580, y: 492 }, { x: 580, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783500239331", blocks: [{ x: 381, y: 525 }, { x: 381, y: 492 }, { x: 60, y: 492 }, { x: 60, y: 568 }, { x: 713, y: 568 }] },
  ],
  "DO": [
    { exit: "exit-1783495197203", blocks: [{ x: 501, y: 525 }, { x: 501, y: 492 }, { x: 580, y: 492 }, { x: 580, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783500239331", blocks: [{ x: 501, y: 525 }, { x: 501, y: 492 }, { x: 60, y: 492 }, { x: 60, y: 568 }, { x: 713, y: 568 }] },
  ],
  "CRA-6": [
    { exit: "exit-1783495197203", blocks: [{ x: 437, y: 458 }, { x: 580, y: 458 }, { x: 580, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783500239331", blocks: [{ x: 437, y: 458 }, { x: 437, y: 422 }, { x: 60, y: 422 }, { x: 60, y: 568 }, { x: 713, y: 568 }] },
  ],
  "Hot-2": [
    { exit: "exit-1783495197203", blocks: [{ x: 679, y: 311 }, { x: 580, y: 311 }, { x: 580, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783495194438", blocks: [{ x: 679, y: 311 }, { x: 775, y: 311 }, { x: 775, y: 348 }, { x: 948, y: 348 }, { x: 948, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783495192196", blocks: [{ x: 679, y: 311 }, { x: 580, y: 311 }, { x: 580, y: 26 }, { x: 948, y: 26 }, { x: 948, y: 568 }, { x: 713, y: 568 }] },
  ],
  "MRM M/C": [
    { exit: "exit-1783495192196", blocks: [{ x: 667, y: 73 }, { x: 667, y: 26 }, { x: 580, y: 26 }, { x: 948, y: 26 }, { x: 948, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783495193102", blocks: [{ x: 667, y: 73 }, { x: 667, y: 26 }, { x: 948, y: 26 }, { x: 948, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783495197203", blocks: [{ x: 667, y: 73 }, { x: 667, y: 105 }, { x: 580, y: 105 }, { x: 580, y: 568 }, { x: 713, y: 568 }] },
  ],
  "IDSM": [
    { exit: "exit-1783495193102", blocks: [{ x: 755, y: 67 }, { x: 755, y: 26 }, { x: 948, y: 26 }, { x: 948, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783495192196", blocks: [{ x: 755, y: 67 }, { x: 755, y: 26 }, { x: 580, y: 26 }, { x: 948, y: 26 }, { x: 948, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783495193815", blocks: [{ x: 755, y: 67 }, { x: 755, y: 105 }, { x: 775, y: 105 }, { x: 775, y: 209 }, { x: 948, y: 209 }, { x: 948, y: 568 }, { x: 713, y: 568 }] },
  ],
  "PNG": [
  ...
  "Admin-B": [
    { exit: "exit-1783495195776", blocks: [{ x: 819, y: 446 }, { x: 852, y: 446 }, { x: 852, y: 468 }, { x: 948, y: 468 }, { x: 948, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783495194438", blocks: [{ x: 819, y: 446 }, { x: 852, y: 446 }, { x: 852, y: 348 }, { x: 948, y: 348 }, { x: 948, y: 568 }, { x: 713, y: 568 }] },
  ],
  "Samvad": [
    { exit: "exit-1783495194438", blocks: [{ x: 819, y: 390 }, { x: 819, y: 348 }, { x: 948, y: 348 }, { x: 948, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783495195776", blocks: [{ x: 819, y: 390 }, { x: 852, y: 390 }, { x: 852, y: 468 }, { x: 948, y: 468 }, { x: 948, y: 568 }, { x: 713, y: 568 }] },
  ],
  "Bag-H": [
    { exit: "exit-1783495194438", blocks: [{ x: 829, y: 267 }, { x: 829, y: 348 }, { x: 948, y: 348 }, { x: 948, y: 568 }, { x: 713, y: 568 }] },
    { exit: "exit-1783495193815", blocks: [{ x: 829, y: 267 }, { x: 829, y: 209 }, { x: 948, y: 209 }, { x: 948, y: 568 }, { x: 713, y: 568 }] },
  ],
  "Store": [
    { exit: "exit-1783495195776", blocks: [{ x: 842, y: 526 }, { x: 948, y: 526 }, { x: 948, y: 568 }, { x: 713, y: 568 }] },
  ],
}
