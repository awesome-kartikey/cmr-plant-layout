...
export const PLANT_LAYOUT_CONFIG: PlantLayoutConfig = {
  ...
  rooms: [
    ...
    // Left Column Cold Refining (Clean Square Proportions, No White Void)
    {
      id: "cra-top-left",
      label: "COLD\nREFINING\nAREA",
    ...
    // Center Section (Cold & Hot Refining)
    {
      id: "cra-center-top",
      label: "COLD\nREFINING\nAREA",
      i18nKey: "map.coldRefiningArea",
    ...
    // Bottom Row - Aligned flush directly under cra-center-bot
    {
      id: "storage-area",
      label: "STORAGE\nAREA",
  ...
  subRooms: [
    ...
    // Sub rooms under Bag House right (y: 310..338)
    {
      id: "toilet-small",
      label: "TOILET",
    ...
    // Reception & Meeting room right side strip (x: 844..888)
    {
      id: "reception",
      label: "RECEPTION\nAREA",
    ...
    // QA Lab (attached flush to Store below), Conference Hall and Stairs (corridor below them)
    {
      id: "qa-lab",
      label: "QA\nLAB",
      i18nKey: "map.qaLab",
  ...
  corridors: [
    ...
    // Internal Vertical Corridor (Straight path right of Samvaad Hall & Admin Block):
    { points: [844, 348, 844, 452], dashed: true },
    // Middle Horizontal Corridor (Exiting right at Reception / Meeting Room):
    { points: [844, 418, 948, 418], dashed: true },
    // Bottom Horizontal Corridor (Between Store and Conference Hall/Stairs, starting right of QA Lab):
    { points: [823, 488, 948, 488], dashed: true },
